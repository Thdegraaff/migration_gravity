...
\begin{figure}[h!]
		\centering
		\includegraphics[width = \columnwidth]{../fig/p_diff_out.pdf}
		\caption{Changes in migration flows when percentage
                  home-ownership in Amsterdam increases by 10\%}\label{fig:diff_out}
\end{figure}
