...
\JournalInfo{Vrije Universiteit Amsterdam} % Journal information
...
\Authors{Thomas de Graaff\textsuperscript{1}\textsuperscript{,}\textsuperscript{2}*} % Authors
...
\affiliation{\textsuperscript{2}\textit{Tinbergen Institute, Amsterdam, The Netherlands}} % Author affiliation
...
\Abstract{In this paper, I address the impact of home-ownership and social
  ...
  model proposed is able to accurately predict migration flows both within and
  out-of-sample.}
