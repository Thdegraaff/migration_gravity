\documentclass[12pt, parskip, abstracton,notitlepage]{scrartcl}

\usepackage{amssymb, amsmath, amsthm, graphics, graphicx, longtable, setspace, makeidx, subfigure, marvosym, microtype, booktabs, authblk, lipsum, siunitx, dcolumn, rotating, listings, epigraph}
...
\usepackage{csquotes}
\usepackage[style=authoryear, bibencoding=utf8, natbib=true, firstinits=false, uniquename=false, backref=false,doi=false,isbn=false,url=false, maxcitenames=2, maxbibnames=10, backend=bibtex]{biblatex}
...
\usepackage[pdftex,colorlinks=true,citecolor=magenta,urlcolor=magenta,pdfstartview=FitH]{hyperref}
			\pdfcompresslevel=9
      \hypersetup{pdftitle={Housing market and migration revisited: a multilevel gravity model for Dutch municipalities},
		   		pdfauthor={Anonymous}} 
