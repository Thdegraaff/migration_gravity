...
<<<<<<< HEAD
%
%\begin{frame}[fragile]{Hamiltonian Monte Carlo (HMC) estimation results}
%		\begin{columns}
%		\begin{column}{0.5\textwidth}
%			\begin{center}
%				\begin{small}
...
\begin{frame}{Observed versus predicted data}
	...
	\end{center}
\begin{itemize}
	\item Predictions have large outliers: caused by Rotterdam (large population, low percentage home-ownership)
\end{itemize}
=======
