...
\begin{frame}{So, this paper}
  ...
  \item[Does what?] \alert{Revisits} the impact of housing market
	...
	\begin{itemize}
		\item UK context by \citet{congdon2010random}
		\item Model \emph{cf.} \citet{koster2014food} \newline
	\end{itemize}
...
\begin{small}
   ...
   \color{blue} city effects}  \\ \pause
	...
	o_{\text{mun}} \\
	d_{\text{mun}}
	\end{matrix}\right) \sim& \text{ MVNormal}(\left( \right) , \sigma_o)  \tag{\footnotesize \color{blue} origin effects}  \\ 
