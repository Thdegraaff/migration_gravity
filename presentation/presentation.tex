...
\begin{frame}{So, this paper}
  ...
  \item[Does what?] \alert{Revisits} the impact of housing market
    ...
    \begin{small}
	\begin{itemize}
	\item \small UK context by \citet{congdon2010random}
	\item \small Social relations model \emph{cf.} \citet{koster2014food} \newline
\end{itemize}
    \end{small}
...
\begin{frame}{Data: migrations flows}
	...
	\end{center}
\begin{itemize}
	\item Migration flows \alert{between} 380 Dutch municipalities in 2018 ($\approx 144,000$)
...
\begin{frame}{Poisson versus negative binomial\footnote{
			...
			Binomial \citep{head2014gravity}}
			}}
...
\begin{small}
   ...
   \color{blue} city effects}  \\ \pause
	...
	\end{matrix}\right) \right)  \tag{\footnotesize \color{blue} varying region effects}  \\ \pause
			\alpha, \sim& \text{ Normal}(1,2) \tag{\footnotesize \color{blue} prior} \\ 
...
\end{center}
\begin{itemize}
	\item \alert{maximum} observed: 3,573
	\item \alert{maximum} predicted: 3,584
\end{itemize}
\end{frame}
