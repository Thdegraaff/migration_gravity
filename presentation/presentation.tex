  ...
  \item Literature on impact of social renting on migration flows is
	...
	\begin{itemize}
        ...
        \item Social renting rights only valid \alert{within} city
          \footnotesize{\citep{boyle1998migration} }
...
\begin{frame}{Robustness checks for social renting}
			\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				\item In general $home < soc < pri$
				\begin{itemize}
					\item But impact $soc \approx 0$\pause
				\end{itemize} 
				\item Robust to:
				\begin{itemize}
					\item year
